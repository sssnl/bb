			...
			"client": {
				"driver": {
					...
					"driver.js": function (exports, module, require) {
						...
						var DateCtor = _hammerhead2.default.nativeMethods.date;
						...
						var SEND_STATUS_REQUEST_TIME_LIMIT = 1000;
						...
						var Driver = function () {
						    ...
						    Driver.prototype._switchToIframe = function _switchToIframe(selector, iframeErrorCtors) {
						        ...
						        return (0, _executeSelector.getResult)(selector, commandSelectorTimeout, null, function (fn) {
						            ...
						            return _this6._ensureChildDriverLink(iframe.contentWindow, iframeErrorCtors.NotLoadedError, commandSelectorTimeout);
					...
					"index.js": function (exports, module, require) {
						...
						_hammerhead2.default.nativeMethods.objectDefineProperty.call(window, window, '%testCafeDriver%', {
						    configurable: true,
						    value: _driver2.default
						});

						_hammerhead2.default.nativeMethods.objectDefineProperty.call(window, window, '%testCafeIframeDriver%', {
						    configurable: true,
						    value: _iframeDriver2.default
						});

						_hammerhead2.default.nativeMethods.objectDefineProperty.call(window, window, '%ScriptExecutionBarrier%', {
						    configurable: true,
						    value: _scriptExecutionBarrier2.default
						});

						_hammerhead2.default.nativeMethods.objectDefineProperty.call(window, window, '%testCafeEmbeddingUtils%', {
						    configurable: true,
						    value: _embeddingUtils2.default
						});

						/* eslint-disable no-undef */
						_hammerhead2.default.on(_hammerhead2.default.EVENTS.evalIframeScript, function (e) {
						    return initTestCafeClientDrivers(e.iframe.contentWindow, true);
						});
